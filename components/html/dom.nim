...
proc createDocumentTypeImpl(
    builder: MiniDOMBuilder, name, publicId, systemId: string
): Node =
  return DocumentType(
...
method setEncodingImpl(
    builder: MiniDOMBuilder, encoding: string
